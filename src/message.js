...
function _encodeChatMessage(message, bb) {
  ...
  if (array$files !== undefined) {
    for (let value of array$files) {
      ...
      _encodeFileContent(value, nested);
  ...
  if ($instructions !== undefined) {
    writeVarint32(bb, 34);
    let nested = popByteBuffer();
    _encodeInstructions($instructions, nested);
    writeVarint32(bb, nested.limit);
    writeByteBuffer(bb, nested);
    pushByteBuffer(nested);
  }

  // optional string projectPath = 5;
  let $projectPath = message.projectPath;
  if ($projectPath !== undefined) {
    writeVarint32(bb, 42);
    writeString(bb, $projectPath);
  }
  ...
  // optional string conversationId = 15;
  let $conversationId = message.conversationId;
  if ($conversationId !== undefined) {
    writeVarint32(bb, 122);
    writeString(bb, $conversationId);
  }

  // optional int32 option = 16;
  let $option = message.option;
  if ($option !== undefined) {
    writeVarint32(bb, 128);
    writeVarint64(bb, intToLong($option));
  }
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      case 1: {
        ...
        values.push(_decodeFileContent(bb));
        bb.limit = limit;
        break;
      }
      ...
      case 4: {
        let limit = pushTemporaryLength(bb);
        message.instructions = _decodeInstructions(bb);
        bb.limit = limit;
        break;
      }
      ...
      // optional string projectPath = 5;
      case 5: {
        message.projectPath = readString(bb, readVarint32(bb));
        break;
      }
      ...
      // optional string requestId = 9;
      case 9: {
        message.requestId = readString(bb, readVarint32(bb));
        break;
      }
      ...
      // optional string conversationId = 15;
      case 15: {
        message.conversationId = readString(bb, readVarint32(bb));
        break;
      }

      // optional int32 option = 16;
      case 16: {
        message.option = readVarint32(bb);
        break;
      }
...
export function encodeResMessage(message) {
  let bb = popByteBuffer();
  _encodeResMessage(message, bb);
  return toUint8Array(bb);
}

function _encodeResMessage(message, bb) {
...
export function decodeResMessage(binary) {
  return _decodeResMessage(wrapByteBuffer(binary));
}

function _decodeResMessage(bb) {
  let message = {};
